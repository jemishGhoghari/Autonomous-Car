...
class DubinCar:
    ...
    def distance_to_target(self):
        ...
        # self.dx = self.target[0] - self.position[0]
        # self.dy = self.target[1] - self.position[1]
    ...
    def planning(self):
        ...
        for i in range(10):
            ...
            random_number = random.uniform(-3.5, 3.5)
            simulation.angle += random_number
            simulation.move()
            d = simulation.distance_to_target()
            # print(rendom_number, d)
            distances.append(d)
            angles.append(random_number)
...
while playing:
    ...
    best_new_angle = car.planning()
    # print(best_new_angle)
    car.angle += best_new_angle
